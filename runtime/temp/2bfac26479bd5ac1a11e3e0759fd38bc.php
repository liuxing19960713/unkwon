<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\news\index.html";i:1541572174;s:83:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\base\css.html";i:1541563428;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
        	<div style="width:10%; float:left;">
                <div class="filter-box">
                    <div class="filter-text">
                        <input class="filter-title" type="text" readonly placeholder="最新资讯" />
                        <i class="icon icon-filter-arrow"></i>
                    </div>
                    <select name="filter" id="filter">
                        <option value="最新资讯" selected>最新资讯</option>
            ...
            <div class="form-group clearfix col-sm-1">
                <a href="<?php echo url('news/add'); ?>"><button class="btn btn-outline btn-primary" type="button">添加文章</button></a>
            </div>
            <!--搜索框开始-->
            ...
            <div class="example-wrap">
                <div class="example">
                      <table class="table">
                          ...
                          <tr>
                              <td align="center"><?php echo $vo['an_id']; ?></td>
                              <td><?php echo $vo['title']; ?></td>
                              <td><img src="<?php echo $vo['img_url']; ?>?imageView2/1/w/120/h/60"/></td>
                              <td align="center"><?php echo $vo['views_count']; ?></td>
                              <td><input class=time<?php echo $vo['an_id']; ?> type="text" value=<?php echo $vo['create_time']; ?> placeholder="请输入日期 年-月-日"></td>
...
<script type="text/javascript">
    function Del(id){
        layer.confirm('确认删除此文章?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('news/Del'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
