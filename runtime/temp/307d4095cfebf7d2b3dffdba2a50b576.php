<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/var/www/html/Unkonwn/public/../application/admin/view/post/edit.html";i:1541563436;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;s:67:"/var/www/html/Unkonwn/public/../application/admin/view/base/js.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $show['post_id']; ?>"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">用户ID：</label>
                            <label class="col-sm-8 control-label" style="text-align:left; padding-left:0; padding-top:9px;"><?php echo $show['user_id']; ?></label>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">用户名：</label>
                            <label class="col-sm-8 control-label" style="text-align:left; padding-left:0;"><?php echo $show['userInfo']['nick_name']; ?></label>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">文章标题：</label>
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="title" required aria-required="true" value="<?php echo $show['title']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">点击率：</label>
                            <div class="input-group col-sm-1">
                                <input id="views_count" type="text" class="form-control" name="views_count" required aria-required="true" value="<?php echo $show['views_count']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">帖子类型：</label>
                            <div class="input-group col-sm-7" style="padding-top:6px;">
                                <label style="margin-right:15px;"><input type="radio" class="rdo" name="post_type" value="normal" > <span class="spans">普通帖</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7" style="padding-top:6px;">
                                <label style="margin-right:15px;"><input type="radio" class="rdo" name="group_type" value="1" > <span class="spans">经验交流</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7" style="padding-top:6px;">
                                ...
                                <label><input type="radio" class="rdo" name="is_top" value="0" > <span class="spans">否</span></label>
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    require(['app','editor', 'post/edit'],function (app, editor, create){
        editor('content');
        create();
        $("input[name='post_type'][value='<?php echo $show['post_type']; ?>']").attr("checked",true);
        $("input[name='group_type'][value='<?php echo $show['group_type']; ?>']").attr("checked",true);
        $("input[name='is_top'][value='<?php echo $show['is_top']; ?>']").attr("checked",true);
        $("input[name='is_best'][value='<?php echo $show['is_best']; ?>']").attr("checked",true);
    });
</script>
</body>
</html>
