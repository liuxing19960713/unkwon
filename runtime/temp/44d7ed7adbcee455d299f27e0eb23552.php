<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/var/www/html/Unkonwn/public/../application/index/view/article/index.html";i:1544255777;s:80:"/var/www/html/Unkonwn/public/../application/index/view/./common/AppDownLoad.html";i:1544255859;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div id="app">
        <div class="ArticleBox clearfix">
            ...
            <p class="SpBox clea">
                ...
                <span class="sp1 views_count" style="margin-right:0.7rem;"><i class="fa fa-eye" style="margin:0 0.2rem;"></i><?php echo $ArticleData['ViewsCount']; ?></span>
                <span class="sp1 classify" style="float:right;"><?php echo $Classify; ?></span>
            </p>
            <p>
            <!-- 文章内容 -->
                ...
                <?php if(is_array($Book1) || $Book1 instanceof \think\Collection || $Book1 instanceof \think\Paginator): $i = 0; $__LIST__ = $Book1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <div class="BookBox clearfix">
                        ...
                        <div class="Box2 clearfix">
                            ...
                            <span class="Book_thumbs"><i class="fa fa-thumbs-up"></i>20</span>
                            <span class="Book_comment"><i class="fa fa-comment"></i>2</span>
                        </div>
                        <span class="Book_time clearfix">2小时前</span>
                        <p class="Book_content"><?php echo $vo['content']; ?></p>
                        <div class="BookBox2 clearfix">
                            <p><span>果果：</span>说得有道理！</p>
                            <p><button>共20条回复></button></p>
                        </div>
                    </div>
...
<div class="Download">
    ...
    优孕宝APP，最懂你的试管婴儿专家
    <a class="bt AppDownLoad" href="https://sj.qq.com/myapp/detail.htm?apkName=com.youyunbb.www.client">立即下载</a>
</div>
...
<script>
    ...
    //     //alert("iOS设备");
    //     $('.AppDownLoad').attr('href','https://sj.qq.com/myapp/detail.htm?apkName=com.youyunbb.www.client');
