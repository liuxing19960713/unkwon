<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/var/www/html/Unkonwn/public/../application/admin/view/tips/edit.html";i:1541572239;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;s:67:"/var/www/html/Unkonwn/public/../application/admin/view/base/js.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $show['tip_id']; ?>"/>
						...
						<div class="form-group">
                            ...
                            <div class="input-group col-sm-3">
								<select class="js_top form-control" name="cate" id="cate">
									<option value="" <?php if($show['cate'] == '0'): ?>selected<?php endif; ?>>请选择分类</option>
									<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
									<option value="<?php echo $vo['id']; ?>" <?php if($show['cate'] == $vo['id']): ?>selected<?php endif; ?>><?php echo $vo['title']; ?></option>
...
<!--                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="sub_title"  value="<?php echo $show['sub_title']; ?>">
                            </div>
                        </div>-->
...
<script>
    require(['app','editor','qiniuUploader', 'tips/edit'],function (app, editor,qiniuUploader, create){
