<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/Unkonwn/public/../application/admin/view/user/useradd.html";i:1541563441;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;s:67:"/var/www/html/Unkonwn/public/../application/admin/view/base/js.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <div class="page-goods-edit ">
                        ...
                        <form id="form" class="form-horizontal">
                            <div class="form-group">
                                <label for="mobile" class="col-xs-3 control-label">账号(手机号)</label>
                                <div class="col-xs-6">
                                    <input type="text" class="form-control" id="mobile" name="mobile" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" maxlength="11" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="nick_name" class="col-xs-3 control-label">昵称</label>
                                <div class="col-xs-6">
...
<script>
    require(['app', 'user/insert'],function (app, create){
        create();
    });
</script>
</body>
