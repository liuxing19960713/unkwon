<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\login.html";i:1541988532;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="signinpanel">
    <div class="row">
        ...
        <div class="col-sm-5">
            <form method="post" action="index.html">
                <p class="m-t-md" id="err_msg">登录到优孕宝后台</p>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2017-2019 All Rights Reserved. 优孕宝
        </div>
    </div>
</div>
