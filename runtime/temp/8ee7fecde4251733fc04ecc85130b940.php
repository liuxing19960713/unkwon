<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/Unkonwn/public/../application/admin/view/increase/add.html";i:1535617237;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1535617233;s:67:"/var/www/html/Unkonwn/public/../application/admin/view/base/js.html";i:1535617233;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-1">
                                <input id="doctor_id" type="text" class="form-control" name="doctor_id">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">点击率：</label>
                            <div class="input-group col-sm-1">
                                <input id="views_count" type="text" class="form-control" name="views_count">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-8" id="editor-container">
...
<script>
    require(['app','editor','qiniuUploader', 'increase/create'],function (app, editor,qiniuUploader, create){
