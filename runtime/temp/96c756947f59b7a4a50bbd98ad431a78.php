<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/var/www/html/Unkonwn/public/../application/admin/view/statement/zhawen2.html";i:1541563438;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<body>
    <div class="Box">
        <div class="clearfix" style="width:350px; margin:10px 0;">
            <!-- 标题名 -->
            <div style="width:30%; float: left;">绑定的文章：</div>
            <input value="<?php echo $return[0]['article']; ?>" name="Title" type="text" style="width:70%; border:1px solid rgb(54, 54, 54);" class="Title1">
            <!-- 标题说明 -->
            <div style="width:30%; float: left;">绑定的二级标题：</div>
            <input value="<?php echo $return[0]['title']; ?>" name="Title2" type="text" style="width:70%; border:1px solid rgb(54, 54, 54);"class="Title2">
            <!-- 抵属文章 -->
            <div style="width:30%; float: left;">数据类型：</div>
            <input value="<?php echo $return[0]['type']; ?>" name="zhawen" type="text" style="width:70%; border:1px solid rgb(54, 54, 54);"class="Title2">
        </div>
        <!-- 加载编辑器的容器 -->
...
<script>
    ...
    ue.ready(function() {
        ...
        ue.setHeight(300);
        //设置默认内容
        ue.setContent('<?php echo $return[0]['content']; ?>');
        //获取纯文本内容，返回: hello
