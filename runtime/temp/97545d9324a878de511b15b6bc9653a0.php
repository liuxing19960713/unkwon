<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/var/www/html/Unkonwn/public/../application/admin/view/increase/index.html";i:1541572320;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        	...
        	<div style="width:10%; float:left;">
                <div class="filter-box">
                    <div class="filter-text">
                        <input class="filter-title" type="text" readonly placeholder="医生讲堂" />
                    ...
                    <select name="filter" id="filter">
                        ...
                        <option value="医生讲堂" selected>医生讲堂</option>
                    </select>
                </div>
            </div>
            <div class="form-group clearfix col-sm-1">
                <a href="<?php echo url('increase/add'); ?>"><button class="btn btn-outline btn-primary" type="button">添加文章</button></a>
            </div>
            <!--搜索框开始-->
            ...
            <div class="example-wrap">
                <div class="example">
                      <table class="table">
                          ...
                          <tr>
                              <td align="center"><?php echo $vo['in_id']; ?></td>
...
<script type="text/javascript">
    function Del(id){
        layer.confirm('确认删除此文章?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('increase/Del'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
