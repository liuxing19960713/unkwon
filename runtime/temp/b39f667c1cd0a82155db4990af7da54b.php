<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\kaifa\php\PHPTutorial\WWW\Unkonwn\public/../application/admin\view\index.html";i:1544428804;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="menu">
                    <a href="<?php echo url('doctor/index'); ?>" class="J_menuItem" >
                ...
                <li class="menu">
                    <!-- <a href="http://app.uyihui.cn/admin/doctor_destoon/" class="J_menuItem" > -->
                        ...
                        <span class="nav-label">公司简介</span>
                    </a>
                </li>
                <?php endif; ?>
                <!-- <li class="menu">
