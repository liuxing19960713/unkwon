<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/var/www/html/Unkonwn/public/../application/admin/view/post/index.html";i:1541563436;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="form-group clearfix col-sm-1">
                <a href="<?php echo url('post/add'); ?>"><button class="btn btn-outline btn-primary" type="button">添加帖子</button></a>
            </div>
            <!--搜索框开始-->
