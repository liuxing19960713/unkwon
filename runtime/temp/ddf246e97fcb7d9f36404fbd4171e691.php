<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/var/www/html/Unkonwn/public/../application/admin/view/event/index.html";i:1541563433;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <a href="<?php echo url('event/add'); ?>"><button class="btn btn-outline btn-primary" type="button">添加活动</button></a>
            </div>
            <!--搜索框开始-->
            ...
            <div class="example-wrap">
                <div class="example">
                      <table class="table">
                          ...
                          <tr>
                              <td align="center"><?php echo $vo['event_id']; ?></td>
                              <td align="center"><a href="/admin/doctor/doctoredit/id/<?php echo $vo['doctor_id']; ?>.html" style="color:#337ab7"><?php echo $vo['doctor_name']; ?></a></td>
                              <td align="center"><img width="50" src="<?php echo $vo['doctor_avatar']; ?>" /></td>
                              <td align="center"><?php echo $vo['doctor_title']; ?></td>
                              <td><?php echo $vo['title']; ?></td>
                              <td align="center"><?php echo $vo['event_status']; ?></td>
...
<script type="text/javascript">
    function Del(id){
        layer.confirm('确认删除此活动?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('event/Del'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
