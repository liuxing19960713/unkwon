<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/var/www/html/Unkonwn/public/../application/admin/view/withdraw/index.html";i:1541563442;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        	...
        	<div style="width:10%; float:left;">
                <div class="filter-box">
                    <div class="filter-text">
                        <input class="filter-title" type="text" readonly placeholder="用户提现" />
                        <i class="icon icon-filter-arrow"></i>
                    </div>
                    <select name="filter" id="filter">
                        <option value="用户提现" selected>用户提现</option>
                        <option value="医生提现">医生提现</option>
                    </select>
                </div>
            </div>
            <!--搜索框开始-->
            ...
            <div class="example-wrap">
                <div class="example">
                      <table class="table">
                          ...
                          <tr>
                              <td align="center"><?php echo $vo['wd_id']; ?></td>
                              <td ><?php echo $vo['nick_name']; ?></td>
                              <td align="center"><?php echo $vo['money']; ?></td>
                              <td align="center"><?php echo $vo['bank_name']; ?></td>
...
<script type="text/javascript">
    function articleDel(id){
        layer.confirm('确认删除此文章?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('withdraw/withdrawDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
	...
	$('.filter-box').selectFilter({
		callBack : function (val){
			...
			if(val=="医生提现"){
				location.href = "<?php echo url('withdraw/doctor'); ?>";
			}
		}
	});
