<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/Unkonwn/public/../application/admin/view/success/add.html";i:1535617241;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1535617233;s:67:"/var/www/html/Unkonwn/public/../application/admin/view/base/js.html";i:1535617233;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <form id="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-1">
                                <input id="views_count" type="text" class="form-control" name="views_count" required aria-required="true">
                            </div>
                        </div>
...
<script>
    require(['app','editor','qiniuUploader', 'success/create'],function (app, editor,qiniuUploader, create){
