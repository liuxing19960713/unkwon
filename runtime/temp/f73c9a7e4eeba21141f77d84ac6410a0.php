<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/Unkonwn/public/../application/admin/view/banner/edit.html";i:1541563428;s:68:"/var/www/html/Unkonwn/public/../application/admin/view/base/css.html";i:1541563429;s:67:"/var/www/html/Unkonwn/public/../application/admin/view/base/js.html";i:1541563429;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <div id="form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-1">
                                <input id="order_num" type="text" class="form-control" name="order_num" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')" value="<?php echo $show['order_num']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="form-inline"  id="container">
                                <div class="input-group col-sm-2">
                            		<img id="imgshow" name="img_url" src="<?php echo $show['img_url']; ?>" width="300" />
                            ...
                            <!-- ios端图 -->
                            <label class="col-sm-3 control-label">缩略图：</label>
                            <input name="img_url2" id="img_url2" value="<?php echo $show['img_url2']; ?>" type="hidden"/>
                            <h3>IOS版本</h3>
                            <div class="form-inline"  id="container">
                                <div class="input-group col-sm-2">
                                    <img id="imgshow2" name="img_url2" src="<?php echo $show['img_url2']; ?>" width="300" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-7">
                                <input id="href_url" type="text" class="form-control" name="href_url" value="<?php echo $show['href_url']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-8">
                                <button id="OK" class="btn btn-primary" type="submit">确认提交</button>
...
<script>
    require(['app','qiniuUploader', 'banner/edit'],function (app,qiniuUploader, create){
...
<script>
    ...
    $('#OK').click(function(){
		...
		$.ajax({
			type: 'post',
			url: 'http://unkonwn.uyihui.cn/admin/Banner/revisedsdk',
			data: { edit: ImgData },
			dataType: 'json',
			success: function(e) {
				if(e=='1') {
