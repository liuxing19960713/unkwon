...
$codes = Re("post","code","string",'');
$mobile = Re("post","mobile","string",'');
...
//     
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIPg2nnlHhU9Ix"; // AccessKeyId

        $accessKeySecret = "3aHzy8OruRx0P7b5z8zVr9fsdzdFlU"; // AccessKeySecret
...
//     
    public static function sendSms($tel,$code) {
        ...
        $request->setSignName("优韵宝");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_137666004");
...
$response = SmsDemo::sendSms($mobile,$codes);
//echo "发送短信(sendSms)接口返回的结果:\n";
//print_r($array);

echo $data['Message'] = $response -> Message; 
